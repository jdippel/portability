    ...
    public static void main(String[] args) {
        ...
        while( true ) {
            ...
            if( requiredSubstring( game.get( "Event" ).get( 0 ), "Classical ") &&
                requiredValue( game.get( "WhiteElo" ).get( 0 ), 2000 ) && requiredValue( game.get( "BlackElo" ).get( 0 ), 2000 ) &&
                requiredSubstring( game.get( "Opening" ).get(0), "Scandinavian Defense" )) {

                // System.out.println( game.toString() );
                // System.out.println( game.getNotation() );
                System.out.println( String.format( "%s:  %s (%s) - %s (%s) - %s", game.get( "Opening" ), game.get( "White" ), game.get( "WhiteElo" ), game.get( "Black" ), game.get( "BlackElo" ), game.get( "Result" ) ) );
